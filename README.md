...
Queen-to-Java Transpiler (Queen made out of Java), version `0.2.2`.
...
Download the latest version (``queen-of-java-0.2.2.jar``) from [here](https://github.com/jvmqueen/queen-of-java/packages) (from ``Assets``).
